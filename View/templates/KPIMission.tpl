                ...
                <div class="modal-body">
                    ...
                    <form ID="createMissionForm">
                        <table class="table">
                            ...
                            <tr><td>任務週期：</td><td><input type="number" name="MissionPeriod" ID="MissionPeriod">天</td></tr>
                        </table>
